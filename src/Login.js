        ...
        <Grid item xs>
          <div className="App-header">
            <DialogTitle id="customized-dialog-title">Sign in with email</DialogTitle>
              ...
              <DialogContentText>
                <text>
                    <Link  onClick={sendData} href="#">{"<"} All Sign in Options</Link>
                </text>
             </DialogContentText>
            <DialogContentText>
            To make Medium work, we log user data and share it with service providers. 
            Click “Sign Up” above to accept Medium’s <Link href="#" ><u>Terms of Service</u></Link> & <Link href="#" ><u>Privacy Policy</u></Link>.
            </DialogContentText>
          </div>
        </Grid>
        <Grid item xs>
