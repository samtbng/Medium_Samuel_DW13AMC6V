        ...
        <Container className={classes.root}>
            <div>
                <Grid container
                    ...
                    spacing={6}
                >
                    <Container style={{ flex: 1, flexDirection: "row", display: "flex" }}>
                        <Grid container style={{ margin: "30px 0 30px 0", flexDirection: "row", display: "flex" }}>
                            <Grid item xs={2}>
                            ...
                            <Grid item xs={1} style={{
                                ...
                                <Button variant="outlined" style={{ color: "primary" }}>
                                    Follow
                            </Button>
                            </Grid>
                        </Grid>
